...
const JUSTIN_PAGE_EDITOR_DATA = {
  ...
  work: {
    content: [
      hero('justin-work-hero', 'Selected Work', 'Professional ecommerce, web and product work built around real business problems.', 'A selection of commercial products, client work and professional ecommerce projects covering Shopify, Adobe Commerce / Magento, SEO, WordPress, frontend development and business workflow design.'),
      block('ProjectCardBlock', 'work-project-justconsignin', {
        logo:'/images/projects/justconsignin-mark.svg',logoAlt:'JustConsignIn Shopify consignment software project mark',
      ...
      block('ProjectCardBlock', 'work-project-jill', {
        logo:'/images/projects/jill-beanstalk-mark.svg',logoAlt:'Jill and The Beanstalk ecommerce project mark',
      ...
      block('ProjectCardBlock', 'work-project-wheels', {
        logo:'/images/projects/wheels-automotive-mark.svg',logoAlt:'Wheels Automotive Dealer Supplies ecommerce project mark',
