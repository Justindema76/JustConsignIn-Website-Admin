...
export const JUSTINDEMATTEIS_PAGES = [
  ...
  },
  {
    ...
    kind: 'content',
    editor: 'visual',
    description: 'Professional ecommerce and development experience with linked case studies.',
  },
  {
    ...
    kind: 'content',
    editor: 'work-post',
    editorTarget: '/admin/work-posts/9001c003-00a3-492b-870b-27b249a5b2b4',
    description: 'JustConsignIn Shopify consignment software case study.',
  },
  {
    id: 'work-jill',
    ...
    kind: 'content',
    editor: 'work-post',
    editorTarget: '/admin/work-posts/bde69606-b7cc-4efd-8d1e-03ea70e9ec86',
    description: 'Jill & The Beanstalk Shopify ecommerce, SEO and growth case study.',
  },
  {
    id: 'work-wheels',
    ...
    kind: 'content',
    editor: 'work-post',
    editorTarget: '/admin/work-posts/e2bffca9-7d77-4cea-9750-5fb14da80d89',
    description: 'Wheels Automotive Adobe Commerce / Magento B2B ecommerce case study.',
  },
  {
    id: 'work-wordpress',
    ...
    kind: 'content',
    editor: 'visual',
    description: 'Grouped WordPress and Elementor client website work.',
  },
  {
    id: 'ai-development',
...
const JUSTIN_PAGE_EDITOR_DATA = {
  home: {
    content: [
      ...
      block('CaseStudyBlock', 'justin-home-case-study', {
        ...
        sectionText: 'JustConsignIn grew from a real consignment workflow problem into a Shopify-focused application for managing consignors, products, sales and payouts.',
        ...
        buttonText: 'Read the story →', buttonUrl: '/work/justconsignin',
  ...
  work: {
    content: [
      hero('justin-work-hero', 'Selected Work', 'Professional ecommerce, web and product work', 'A selection of commercial products, client work and professional ecommerce projects covering Shopify, Adobe Commerce / Magento, SEO, WordPress, frontend development and business workflow design.'),
      block('ProjectCardBlock', 'work-project-justconsignin', {
        logo:'https://nowsajdmbpxvlvrhopjg.supabase.co/storage/v1/object/public/site-assets/1790194715243-justconsigin-logo.png',logoAlt:'JustConsignIn Shopify consignment software project mark',
        companyLabel:'Company / Product',companyName:'JustConsignIn',category:'Shopify App · Consignment Software',eyebrow:'Product Development',
        heading:'Shopify consignment software connecting intake, products, POS sales and payouts.',headingLevel:'h2',
        summary:'JustConsignIn is a Shopify-native consignment management application I designed and built to replace fragmented intake, product-entry, sales-tracking and payout workflows. It connects consignors, inventory, Shopify product creation, Shopify POS sales, commission calculations and payouts in one organized system.',
        roleLabel:'My role',roleText:'Product Strategy · UX/UI · Full-Stack Development · Shopify Integration · Supabase Architecture',
        audienceLabel:'Built for',audienceText:'Consignment, resale and secondhand stores using Shopify and Shopify POS',
        tags:'Shopify, React, Supabase, Shopify POS, REST APIs, Mobile Intake, Payouts, AI-Assisted Development',
        note:'Case study covering the product problem, workflow design, Shopify integration, application architecture, development process and product decisions.',
        buttonText:'View JustConsignIn Case Study →',buttonUrl:'/work/justconsignin',panelPosition:'left',anchorId:'justconsignin',
      }),
      block('ProjectCardBlock', 'work-project-jill', {
        logo:'https://nowsajdmbpxvlvrhopjg.supabase.co/storage/v1/object/public/site-assets/1790194733233-jillandthebeanstalk-logo-thumb.png',logoAlt:'Jill and The Beanstalk ecommerce project mark',
        companyLabel:'Client / Ecommerce',companyName:'Jill & The Beanstalk',category:'Shopify Ecommerce · SEO · Growth',eyebrow:'Ecommerce Growth',
        heading:'Growing a Shopify store through SEO, ecommerce improvements and ongoing optimization.',headingLevel:'h2',
        summary:'My work with Jill & The Beanstalk spans Shopify storefront improvements, technical and on-page SEO, product and category content, search visibility, reviews, integrations and conversion-focused updates. The goal is consistent: make the store easier to discover, easier to shop and stronger as an online sales channel.',
        roleLabel:'My role',roleText:'Shopify Management · SEO · Ecommerce UX · Content · Integrations · Growth',
        audienceLabel:'Business',audienceText:'Children’s retail and resale business serving customers online and in-store',
        tags:'Shopify, SEO, Google Search Console, Judge.me, Doofinder, Content, Analytics, Conversion',
        note:'Case study focused on organic visibility, storefront improvements, ecommerce growth and the ongoing work behind a real operating store.',
        buttonText:'View Jill & The Beanstalk Case Study →',buttonUrl:'/work/jill-and-the-beanstalk',panelPosition:'right',anchorId:'jill-and-the-beanstalk',
      }),
      block('ProjectCardBlock', 'work-project-wheels', {
        logo:'https://wheelsauto.com/media/logo/stores/6/wheelsauto_logo_2.svg',logoAlt:'Wheels Automotive Dealer Supplies ecommerce project mark',
        companyLabel:'Professional Work',companyName:'Wheels Automotive',category:'Adobe Commerce / Magento · B2B Ecommerce',eyebrow:'B2B Ecommerce',
        heading:'Supporting the launch and ongoing improvement of a large automotive B2B ecommerce platform.',headingLevel:'h2',
        summary:'At Wheels Automotive Dealer Supplies, I work across Adobe Commerce / Magento frontend implementation, PageBuilder content, B2B account and checkout testing, QA, product and category SEO, merchandising content and launch support. The work spans Canadian, French and U.S. storefront requirements and ongoing coordination with the implementation vendor.',
        roleLabel:'My role',roleText:'Ecommerce Development · Frontend · QA · SEO · Content Architecture · Vendor Coordination',
        audienceLabel:'Built for',audienceText:'Automotive dealerships, dealer groups and automotive retail operations',
        tags:'Adobe Commerce, Magento 2, PageBuilder, B2B Ecommerce, HTML/CSS, QA, SEO, Product Content',
        note:'Case study covering the B2B launch, frontend work, QA, SEO, product/category systems and ongoing ecommerce improvements.',
        buttonText:'View Wheels Automotive Case Study →',buttonUrl:'/work/wheels-automotive',panelPosition:'left',anchorId:'wheels-automotive',
      }),
      block('ProjectCardBlock', 'work-project-wordpress', {
        logo:'/images/projects/wordpress-websites-mark.svg',logoAlt:'WordPress client websites project mark',
        companyLabel:'Client Websites',companyName:'WordPress Websites',category:'WordPress · Elementor · Small Business',eyebrow:'Web Development',
        heading:'Responsive WordPress websites designed around the needs of small businesses.',headingLevel:'h2',
        summary:'A grouped portfolio of WordPress client work including Sunluna Vacations and TOdecks.ca. The work covers responsive Elementor builds, navigation and page structure, forms and email delivery, client content and imagery, mobile usability, SEO and ongoing website support.',
        roleLabel:'My role',roleText:'WordPress Development · Elementor · Responsive Design · Forms · SEO · Site Support',
        audienceLabel:'Built for',audienceText:'Small businesses and service-based companies that need practical, maintainable websites',
        tags:'WordPress, Elementor, CSS, Responsive Design, Forms, SEO, HostPapa, Content Integration',
        note:'Collection page showing individual WordPress projects, the business requirement for each site and the specific work completed.',
        buttonText:'View WordPress Website Projects →',buttonUrl:'/work/wordpress-websites',panelPosition:'right',anchorId:'wordpress-websites',
      }),
    ],
    root: { props: {} },
  },
  ...
  about: {
    content: [
      block('HeroBlock', 'justin-about-hero', {
        eyebrow:'About Justin DeMatteis',
        heading:'Developer, product builder and problem solver with an engineering background.',
        text:'I started in mechanical engineering technology, CNC programming and tool & die design, then retrained in web and mobile development. Today I work across ecommerce, custom software, Shopify, Adobe Commerce and AI-assisted development — building practical tools around real business workflows.',
        image:'',imageAlt:'',buttonText:'View my experience →',buttonUrl:'/experience',background:'light',
      }),
      block('StorySplitBlock', 'justin-about-story', {
        leftEyebrow:'Background',
        leftHeading:'I came into software from manufacturing and engineering.',
        leftText1:'My first career was built around mechanical engineering technology, CNC machining and programming, and tool & die design. That work taught me to think in systems, understand tolerances, solve practical problems and pay attention to how a process actually works from start to finish.',
        leftText2:'When I moved into web and mobile development, I brought that same mindset with me: understand the problem first, then build the simplest reliable solution around the people who have to use it.',
        rightEyebrow:'What I do now',
        rightHeading:'I build and improve digital products that have to work in the real world.',
        point1Title:'Product development',point1Text:'I designed and built JustConsignIn, a Shopify-focused consignment application connecting intake, products, POS sales, commissions and payouts.',
        point2Title:'Professional ecommerce',point2Text:'At Wheels Automotive, I work with Adobe Commerce / Magento across frontend implementation, B2B workflows, QA, SEO, product content and launch support.',
        point3Title:'Client ecommerce + SEO',point3Text:'My work for Jill & The Beanstalk includes Shopify improvements, SEO, search visibility, content, integrations and ongoing ecommerce growth work.',
        point4Title:'Web + AI-assisted development',point4Text:'I also build WordPress sites and custom tools, using AI throughout research, architecture, coding, debugging and iteration to move from idea to working software faster.',
      }),
      block('SkillsGridBlock', 'justin-about-skills', {
        eyebrow:'What I bring',
        heading:'A mix of development, ecommerce and practical business problem-solving.',
        text:'I am most useful when the work crosses boundaries — code, UX, ecommerce, content, data and the real workflow behind the screen.',
        item1Title:'Development',item1Text:'React, JavaScript, TypeScript, Node, PHP, MySQL, Supabase, REST APIs and responsive frontend development.',
        item2Title:'Ecommerce',item2Text:'Shopify, Shopify POS, Adobe Commerce / Magento, WordPress, product workflows, SEO and storefront improvement.',
        item3Title:'Product thinking',item3Text:'Workflow mapping, data structure, UX decisions, rapid prototyping, testing and iteration around real user needs.',
        item4Title:'Delivery',item4Text:'GitHub, Vercel, QA, deployment, documentation, analytics and AI-assisted development from concept through launch.',
      }),
      block('LargeCtaBlock', 'justin-about-cta', {
        eyebrow:'Selected work',heading:'The best explanation of how I work is in the projects.',buttonText:'View my work →',buttonUrl:'/work',
      }),
    ],
    root: { props: {} },
  },
